...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    # بررسی وجود کاربر
    is_approved, profile = UserService.check_user_approval_status(telegram_id)
...
async def handle_contact(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        user_obj, profile, created = UserService.create_user_from_telegram(
...
async def show_prices(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    products = TradingService.get_active_products()
...
async def show_history(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    orders = TradingService.get_user_recent_orders(profile, limit=5)
...
async def buy_product_selected(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    product = TradingService.get_product_by_id(product_id)
    if not product:
