...
async def show_history(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    # Format each order using sync_to_async since it accesses related product
    for order in orders:
        formatted_order = await sync_to_async(OrderService.format_order_for_display)(order)
        message += formatted_order + "\n"
