...
def update_margins_with_percentage():
    ...
    from trading.price_providers import get_active_provider, AnigoldPriceProvider
    
    provider = get_active_provider()
    
    # Try to get prices if available
    try:
        # Only AnigoldPriceProvider supports get_price() method
        if isinstance(provider, AnigoldPriceProvider):
            prices = provider._fetch_all_prices()
            ...
            print("⚠️  Current price provider does not support get_price() method.")
