...
class Profile(models.Model):
    ...
    @classmethod
    async def aget_by_telegram_id(cls, telegram_id: str) -> Optional['Profile']:
        """نسخهٔ ناهمگام برای دریافت پروفایل براساس شناسه تلگرام"""
        try:
            return await sync_to_async(
                lambda: cls.objects.select_related('user').get(telegram_id=telegram_id),
