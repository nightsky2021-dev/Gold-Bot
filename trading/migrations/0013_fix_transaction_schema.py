# Generated by Django 4.2.25 on 2025-11-04 20:29

from django.db import migrations, models
import django.db.models.deletion


def fix_transaction_table(apps, schema_editor):
    """Drop and recreate transaction tables with correct schema."""
    db_alias = schema_editor.connection.alias
    
    # Use raw SQL to drop and recreate tables
    with schema_editor.connection.cursor() as cursor:
        # Drop old tables
        cursor.execute("DROP TABLE IF EXISTS trading_withdrawrequest")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('trading', '0012_add_missing_currency_column'),
    ]

    operations = [
        # First drop the old tables
        migrations.RunPython(fix_transaction_table, reverse_code=migrations.RunPython.noop),
        
        # Then recreate Transaction with correct schema
        ...
        migrations.AddIndex(
            model_name='transaction',
            index=models.Index(fields=['status', '-created_at'], name='trading_tra_status_b8c123_idx'),
        ),
        migrations.AddIndex(
            model_name='transaction',
            index=models.Index(fields=['transaction_type', 'status'], name='trading_tra_transac_a45e67_idx'),
        ),
        
        # Recreate WithdrawRequest with correct schema
        migrations.CreateModel(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['profile', '-created_at'], name='trading_wit_profile_8a9b12_idx'),
        ),
        migrations.AddIndex(
            model_name='withdrawrequest',
            index=models.Index(fields=['status', '-created_at'], name='trading_wit_status_c3d456_idx'),
        ),
    ]
